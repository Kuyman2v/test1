...

{
  ...
  PINMUX8  = 0x21141111;  // UART2, McASP1, I2C0, I2C1
  PINMUX9  = 0x00080802;  // RMII CLK, McASP0, USB_DRVVBUS, UART2
  PINMUX10 = 0x00000008;  // RMII/ McASP0
  PINMUX11 = 0x08888888;  // McASP1, UART1, McASP0, MDIO (last 2 digits 0x22 for MDIO instead of GPIO)
  PINMUX12 = 0x80000000;  // McASP0 / McASP1
  PINMUX13 = 0x11800088;
  PINMUX14 = 0x11111111;
  PINMUX15 = 0x11111111;
  PINMUX16 = 0x11111111;
  ...
  //PINMUX8_31_28 uart2_rxd   PINMUX8_19_16 uart0_TXD PINMUX8_15_12 uart_RXD
  PINMUX8  = 0x21811188;
  PINMUX9 =0x00800002;  //23！！20  gp2_14 con1   3-0 uart2_txd
  PINMUX11 = 0x00001100; //UART1_TXD,UART1_RXD

  PINMUX12 = 0x80800008;  // 23！！20  con2  led3
...
void InitPLL(void)
{
  ...
  {
    ; /*Make PLLEN_MUX_SWITCH as bootpacket*/
  }
  ...
  for(i=0; i<PLL_LOCK_TIME_CNT; i++) {
    ; /*Make PLL_LOCK_TIME_CNT as boot Packet*/
  }
